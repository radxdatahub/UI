...
export async function getServerSideProps(context) {
    logger.defaultMeta.service = 'Study Registration - DCC View';
    const { req } = context;
    ...
    return {
        props: { type: 'DCC', studyInfo, formData, codeListsValues, PDF_URL: DOWNLOAD_STUDY_REG_PDF.replace('[studyId]', studyId) },
    };
}
