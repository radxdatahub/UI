...
export const approvedData = {
    ...
    sections: [
            ...
            content: (
                <>
                    <p className={classes.tutorialListItem}>
                        My Approved Data allows you to access data files based on your Database of Genotypes and Phenotypes (dbGaP)
                        approvals. This page will group files into one table per study. Within each study table, the files are organized by
                        bundles, which is a set of files including a data file, metadata file, and data dictionary (along with any SAS file
                    ...
                    <ul>
                        <li className={classes.tutorialListItem}>
                            <a href="#download-files-ad">Download approved data files</a>
                        </li>
                        <li className={classes.tutorialListItem}>
                            <a href="#apply-for-add-ons">Apply for Workbench add-ons</a>
                        </li>
                        <li className={classes.tutorialListItem}>
                        ...
                        <li className={classes.tutorialListItem}>
                            <a href="#add-files-workbench">Add files to your workbench</a>
                        </li>
                    </ul>
                    <p>
                        <i className={classes.tutorialListItem}>
                            Note: My Approved Data will be empty until you are approved to access to at least one study in dbGaP.
                        </i>
                    </p>
        ...
        },
        {
            ...
            content: (
                <>
                    <p className={classes.tutorialListItem}>To download files, select them using one of three techniques:</p>
                    <ul>
                        <li className={classes.tutorialListItem}>
                            <i>Option 1 - Select a Bundle</i>: To select a bundle, check the box next to a harmonized or non-harmonized data
                            file. This will select the high-level data file and its supporting files (i.e., metadata and data dictionary
                            files).
                        </li>
                        <li className={classes.tutorialListItem}>
                            <i>Option 2 - Select an Individual File</i>: This process varies for supporting files (e.g., metadata and data
                            dictionary files) and data files. To select a metadata or data dictionary file, check the box next to the file
                            name. To select an individual harmonized or non-harmonized file, first check the box next to the file name. This
                            will select the entire bundle. Then, deselect the metadata and data dictionary files.
                        </li>
                        <li className={classes.tutorialListItem}>
                    ...
                    <p className={classes.tutorialListItem}>
                        After selecting the desired files, you can click “Zip & Download,” and the files will appear in your browser’s
                        download center as a zip file, which you can save or open.
                    </p>
                    <div className={classes.tutorialImg}>
        ...
        },
        {
            ...
            content: (
                <>
                    <p className={classes.tutorialListItem}>
                        After registering, you will automatically have the default Workbench access, which includes JupyterLab and RStudio
                        but does not include Data Wrangler or SAS Viya. To access those tools, you must apply for a Workbench Add-on. To
                        apply:
                    </p>
                    <ol>
                        <li className={classes.tutorialListItem}>
                        ...
                        <li className={classes.tutorialListItem}>Fill out the required fields.</li>
                        <div className={classes.tutorialImg}>
                        ...
                        <li className={classes.tutorialListItem}>
                            Download and read the Terms of Service. You should type your name in the “Agree to the Terms of Service” field
                            if you agree.
                        </li>
                        <li className={classes.tutorialListItem}>
                            Press “Submit.” The team will review the request and email you if you are approved for a Workbench Add-on.
                        </li>
                    </ol>
                    <i>
        ...
        },
        {
            ...
            content: (
                <>
                    <p className={classes.tutorialListItem}>
                        To create a workbench, press “Create Workbench.” In the future, press “Launch Workbench” to access an existing
                        workbench.
                    </p>
                    <div className={classes.tutorialImg}>
        ...
        },
        {
            ...
            content: (
                <>
                    <p className={classes.tutorialListItem}>
                        To add approved files to a workbench, select the file or files to transfer. Then, click “Add to Workbench” in the
                        top right of the study table (Figure 6).
                    </p>
                    <div className={classes.tutorialImg}>
