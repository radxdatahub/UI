    ...
    sections: [
        ...
        },
        {
            ...
            content: (
                <>
                    <p>
                        Request study data access, including harmonized and non-harmonized data file access in dbGaP. Navigate to the{' '}
        ...
        },
        {
            ...
            content: (
                <>
                    ...
                    <div className={classes.tutorialImg}>
                        <Image src={figure2StudyOverview} alt="Figure 2: Download Functionality in Documents Table" />
                    </div>
                    <figcaption className={classes.figureCaption}>Figure 2: Download Functionality in Documents Table</figcaption>
                </>
            ),
            subSections: [],
        },
            ...
            content: (
                <>
                    ...
                    <p>
                        ...
                        (Figure 3). The file will show up in the browser’s download center for you to open or to save.
                    </p>
                    ...
                    <div className={classes.tutorialImg}>
                        <Image src={figure3StudyOverview} alt="Figure 3: Data Files Table" />
                    </div>
                    <figcaption className={classes.figureCaption}>Figure 3: Data Files Table</figcaption>
                    <br />
                    <p>
                    ...
                    <div className={classes.tutorialImg}>
                        <Image src={figure4StudyOverview} alt="Figure 4: Metadata Viewer" />
                    </div>
                    <figcaption className={classes.figureCaption}>Figure 4: Metadata Viewer</figcaption>
                    <br />
                    <p>
                        You can also view information on data file-based variables contained by clicking the carrot in the “Number of
                        Variables” column (Figure 5). This will open a table, letting you find the data file variables.
                    </p>
                    <div className={classes.tutorialImg}>
                        <Image src={figure5StudyOverview} alt="Figure 5: Variables Information in the Data Files Table" />
                    </div>
                    <figcaption className={classes.figureCaption}>Figure 5: Variables Information in the Data Files Table</figcaption>
                </>
            ),
            subSections: [],
        },
