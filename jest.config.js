...
module.exports = {
    ...
    // cacheDirectory: "C:\\Users\\Leon\\AppData\\Local\\Temp\\jest",
    ...
    // Helps jest understand jsx syntax. Using custom babel config file for testing
    // (Needs to be custom babel config file because naming it the default causes the app to disable SWC when running and breaks)
    ...
    // https://stackoverflow.com/questions/71207221/babel-config-js-only-for-jest
    transform: {
        '^.+\\.(js|jsx)$': ['babel-jest', { configFile: './babel.config.testing.js' }],
    },

    // Helps jest parse CSS, SCSS, and PDF files for us
    // See more information at: https://jestjs.io/docs/webpack#handling-static-assets
    moduleNameMapper: {
