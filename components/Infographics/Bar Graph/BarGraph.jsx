...
/**
 * A bar graph that can showcase data in infographs and more detailed graphs.
 ...
 * See /BarGraph.stories.js for data example
 ...
 * @returns {JSX} A BarGraph React Component
 */
...
const BarGraph = (props) => {
    ...
    //TODO: We need to work with the person that makes a11yLegend so it actually functions properly
    ChartJS.register(CategoryScale, LinearScale, BarElement, Title, Tooltip, Legend, a11yLegend);
